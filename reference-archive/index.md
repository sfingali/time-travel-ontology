# Time Travel & Interacting Universes — Master Catalog
...
## Candidate pools
- [Anglophone AV](candidates/anglophone-av.md) (~270)
- [Non-English AV](candidates/non-english-av.md) (~320)
- [Novels worldwide](candidates/novels-worldwide.md) (252)

## Diagram pack (post hunt)
- **~281** unique URLs · **~70** local images · multi-user variants
- [DIAGRAM_HUNT_SUMMARY.md](diagrams/DIAGRAM_HUNT_SUMMARY.md)
- [VARIATIONS.md](diagrams/VARIATIONS.md) · [MASTER-DIAGRAM-INDEX.md](diagrams/MASTER-DIAGRAM-INDEX.md)
